...
/* =========================================================
   PAGE: SM PACK (AI Sosyal Medya Paketi) — V1 Skeleton
   - Sadece görünüm; layout bozulmaz
   - Mevcut card / panel sistemine uyumlu
   ========================================================= */

.page-sm-pack .panel-header{
  margin-bottom: 14px;
}
