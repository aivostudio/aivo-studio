...
(() => {
  ...
  /* =========================
     Kredi Al tetikleyicileri
     - #creditsButton varsa onu da bağlar
     - data-open-pricing olanları bağlar
     ========================= */
  ...
  if (pricingModal.dataset.boundBuyDelegate !== "1") {
    ...
    pricingModal.addEventListener("click", (e) => {
      ...
      // KRİTİK: alttaki global click handler / link handler tetiklenmesini kes
      e.preventDefault();
      e.stopPropagation();
      e.stopImmediatePropagation?.();
      ...
      if (typeof window.switchPage === "function") {
        ...
        // fallback: en azından checkout içeriğini render et
  ...
  // İstersen checkout sayfasına dönüşte güncel veri bas
