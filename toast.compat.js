...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V88__) return;
  window.__AIVO_AD_FILM_ASSETS_V88__ = true;
  ...
  const styles = [
    ...
    "/css/ad-film.unified-flow.css?v=3",
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.progress-stability.js?v=13",
