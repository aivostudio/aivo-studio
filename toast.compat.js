...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V45__) return;
  window.__AIVO_AD_FILM_ASSETS_V45__ = true;
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.avatar-recovery.js?v=1",
    "/js/ad-film.avatar-stuck-recovery.js?v=1",
    ...
    "/js/ad-film.avatar-orchestrator.js?v=5",
