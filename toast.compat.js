...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V83__) return;
  window.__AIVO_AD_FILM_ASSETS_V83__ = true;
  ...
  const styles = [
    ...
    "/css/ad-film.production-status-center.css?v=5",
    "/css/ad-film.unified-flow.css?v=2",
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.confirm-progress-bridge.js?v=3",
    "/js/ad-film.progress-lock.js?v=6",
    "/js/ad-film.music-preflight.js?v=4",
    "/js/ad-film.server-state-sync.js?v=1",
    "/js/ad-film.seedance-resume-guard.js?v=3",
    "/js/ad-film.seedance-engine.js?v=8",
    "/js/ad-film.progress-stability.js?v=12",
    "/js/ad-film.logo-finalize.js?v=4",
    "/js/ad-film.finalize-output.js?v=8",
    "/js/ad-film.mix-upgrade.js?v=3",
    "/js/ad-film.result-controls.js?v=11",
    "/js/ad-film.live-preview-state.js?v=4",
    ...
    "/js/ad-film.idle-ui-cleanup.js?v=4"
  ];
