(() => {
  ...
  const RECOVERABLE_ADFILM_RE = /(avatar_pipeline_not_started|seedance_generation_not_ready|generation_in_progress|hibrit reklam üretimi başlatılamadı|hybrid production could not start|üretim isteği başarısız oldu)/i;
...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V57__) return;
  window.__AIVO_AD_FILM_ASSETS_V57__ = true;

  const styles = [
    "/css/mod.ad-film.css?v=6","/css/ad-film.preview.css?v=2","/css/ad-film.basic-polish.css?v=4","/css/ad-film.basic-draft.css?v=1","/css/ad-film.project-sync.css?v=2","/css/ad-film.cloud-status-fix.css?v=1","/css/ad-film.readability.css?v=1","/css/ad-film.vibrant-actions.css?v=2","/css/ad-film.production-state.css?v=1","/css/ad-film.storyboard.css?v=1","/css/ad-film.simple-mode.css?v=3","/css/ad-film.music-profile.css?v=5","/css/ad-film.seedance-options.css?v=4","/css/ad-film.creative-plan.css?v=1","/css/ad-film.creative-plan-tune.css?v=2","/css/ad-film.role-readability.css?v=3","/css/ad-film.role-balance.css?v=1","/css/ad-film.narration-guide.css?v=1","/css/ad-film.narration-engine.css?v=2","/css/ad-film.narration-player.css?v=2","/css/ad-film.avatar.css?v=3","/css/ad-film.avatar-appearance.css?v=2","/css/ad-film.avatar-upload-state.css?v=1","/css/ad-film.avatar-actions.css?v=1","/css/ad-film.avatar-direction.css?v=3","/css/ad-film.seedance-engine.css?v=5","/css/ad-film.result-controls.css?v=7","/css/ad-film.output-workflow.css?v=1","/css/ad-film.output-gallery.css?v=3","/css/ad-film.video-modal.css?v=1","/css/ad-film.premium-production.css?v=3","/css/ad-film.production-status-center.css?v=1","/css/ad-film.unified-flow.css?v=1"
  ];
  const shellScripts = ["/js/ad-film.route-fix.js?v=6","/js/ad-film.skeleton.js?v=8","/js/ad-film.reopen-fix.js?v=1"];
  const moduleScripts = [
    "/js/ad-film.i18n.js?v=1","/js/ad-film.controls-fix.js?v=3","/js/ad-film.basic-polish.js?v=3","/js/ad-film.basic-draft.js?v=2","/js/ad-film.basic-media-cache.js?v=2","/js/ad-film.language-lock.js?v=3","/js/ad-film.storyboard.js?v=1","/js/ad-film.simple-mode.js?v=3","/js/ad-film.music-profile.js?v=8","/js/ad-film.project-sync.js?v=6","/js/ad-film.lifecycle-guard.js?v=3","/js/ad-film.avatar.js?v=6","/js/ad-film.avatar-appearance.js?v=3","/js/ad-film.avatar-direction.js?v=5","/js/ad-film.avatar-actions.js?v=1","/js/ad-film.seedance-upload-fix.js?v=1","/js/ad-film.seedance-options.js?v=2","/js/ad-film.creative-plan.js?v=1","/js/ad-film.role-upload-fix.js?v=3","/js/ad-film.reference-indexes.js?v=1","/js/ad-film.reset-fix.js?v=2","/js/ad-film.reset-safety.js?v=1","/js/ad-film.narration-guide.js?v=1","/js/ad-film.narration-engine.js?v=3","/js/ad-film.narration-approval-sync.js?v=11","/js/ad-film.narration-player-host-fix.js?v=1","/js/ad-film.narration-player.js?v=2","/js/ad-film.narration-master.js?v=3","/js/ad-film.narration-build-guard.js?v=4","/js/ad-film.voice-toggle-fix.js?v=2","/js/ad-film.hybrid-controller.js?v=9","/js/ad-film.music-preflight.js?v=4","/js/ad-film.seedance-resume-guard.js?v=3","/js/ad-film.finalize-wait.js?v=3","/js/ad-film.avatar-orchestrator.js?v=12","/js/ad-film.avatar-finalization-bridge.js?v=1","/js/ad-film.seedance-engine.js?v=6","/js/ad-film.progress-stability.js?v=4","/js/ad-film.logo-finalize.js?v=4","/js/ad-film.finalize-output.js?v=5","/js/ad-film.mix-upgrade.js?v=3","/js/ad-film.result-controls.js?v=11","/js/ad-film.live-preview-state.js?v=4","/js/ad-film.output-workflow.js?v=2","/js/ad-film.video-modal.js?v=1","/js/ad-film.output-gallery.js?v=9","/js/ad-film.project-history-stable.js?v=2","/js/ad-film.output-main-delete.js?v=2","/js/ad-film.output-sync.js?v=1","/js/ad-film.idle-ui-cleanup.js?v=1"
  ];
