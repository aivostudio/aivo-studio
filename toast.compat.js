...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V108__) return;
  window.__AIVO_AD_FILM_ASSETS_V108__ = true;
  ...
  const styles = [
    ...
    "/css/ad-film.vibrant-actions.css?v=5",
    ...
    "/css/ad-film.advanced-alignment.css?v=4",
    "/css/ad-film.credit-pricing.css?v=2",
