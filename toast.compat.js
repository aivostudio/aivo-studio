...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V94__) return;
  window.__AIVO_AD_FILM_ASSETS_V94__ = true;
  ...
  const styles = [
    ...
    "/css/ad-film.advanced-alignment.css?v=1",
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.seedance-options.js?v=4",
