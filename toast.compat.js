...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V106__) return;
  window.__AIVO_AD_FILM_ASSETS_V106__ = true;
  ...
  const styles = [
    ...
    "/css/ad-film.credit-pricing.css?v=1",
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.credit-pricing.js?v=1",
