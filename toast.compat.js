...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_CLEAN_V3__) return;
  window.__AIVO_AD_FILM_ASSETS_CLEAN_V3__ = true;
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.production-controller-v2.js?v=1",
    ...
    "/js/ad-film.quality-ui-only.js?v=2"
  ];
