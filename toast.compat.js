...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V77__) return;
  window.__AIVO_AD_FILM_ASSETS_V77__ = true;
  ...
  const styles = [
    ...
    "/css/ad-film.unified-flow.css?v=1"
  ];

  const shellScripts = [
    "/js/ad-film.route-fix.js?v=6",
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.progress-lock.js?v=5",
    ...
    "/js/ad-film.progress-stability.js?v=10",
