...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V92__) return;
  window.__AIVO_AD_FILM_ASSETS_V92__ = true;
  ...
  const styles = [
    ...
    "/css/ad-film.duration-ratio-clarity.css?v=1",
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.seedance-options.js?v=3",
