...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V73__) return;
  window.__AIVO_AD_FILM_ASSETS_V73__ = true;
  ...
  const styles = [
    ...
    "/css/ad-film.production-status-center.css?v=4",
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.progress-lock.js?v=2",
    ...
    "/js/ad-film.progress-stability.js?v=9",
