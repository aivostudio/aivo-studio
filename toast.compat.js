...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V35__) return;
  window.__AIVO_AD_FILM_ASSETS_V35__ = true;
  ...
  const styles = [
    ...
    "/css/ad-film.avatar-direction.css?v=2",
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.lifecycle-guard.js?v=2",
    "/js/ad-film.avatar.js?v=3",
    "/js/ad-film.avatar-direction.js?v=4",
    ...
    "/js/ad-film.finalize-wait.js?v=1",
    "/js/ad-film.avatar-orchestrator.js?v=3",
    ...
    "/js/ad-film.live-preview-state.js?v=2",
