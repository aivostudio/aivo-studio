...
/* =========================================================
   TOPBAR USER MENU — SINGLE OWNER (SAFE)
   - btnUserMenuTop -> topUserMenu toggle
   - outside click / ESC closes
   - include ile sonradan gelse bile çalışır (delegated)
   ========================================================= */
(function bindTopbarUserMenu(){
  if (window.__AIVO_TOPBAR_USERMENU_BOUND__) return;
  window.__AIVO_TOPBAR_USERMENU_BOUND__ = true;
  ...
  // ✅ Delegated click (include geç gelse bile)
  document.addEventListener("click", (e) => {
