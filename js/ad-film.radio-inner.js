(() => {
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      .adfilm-radio-durations{grid-template-columns:repeat(5,minmax(0,1fr));gap:7px}
      .adfilm-radio-durations button{min-height:36px;padding:0 7px;border-radius:10px;font-size:12px}
      ...
      @media(max-width:900px){.radio-voice-hero{grid-template-columns:54px minmax(0,1fr)}.radio-voice-hero__status{grid-column:1/-1;width:max-content}.radio-preview__player{grid-template-columns:48px minmax(0,1fr) 36px 36px 36px}.adfilm-radio-production__steps{grid-template-columns:1fr}.adfilm-radio-durations{grid-template-columns:repeat(3,minmax(0,1fr))}}
    `;
