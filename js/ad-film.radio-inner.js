(() => {
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      .radio-output-options{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-bottom:8px}.radio-output-options button{display:grid;gap:2px;min-height:58px;padding:8px 10px;border:1px solid rgba(111,85,171,.45);border-radius:12px;background:linear-gradient(145deg,rgba(34,30,67,.96),rgba(21,21,48,.96));color:#b9b2c8;text-align:left;font:inherit;cursor:pointer}
      .radio-output-options b{color:#f5f1fb;font-size:14px}.radio-output-options strong{font-size:11px}.radio-output-options small{color:#8f899e;font-size:9px}.radio-output-options button.is-active{border-color:rgba(255,255,255,.44);background:linear-gradient(120deg,#7447f5,#bf4ed5,#ef58a8);color:#fff;box-shadow:0 8px 18px rgba(129,64,220,.24)}.radio-output-options button.is-active b,.radio-output-options button.is-active small{color:#fff}
