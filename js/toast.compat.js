...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V11__) return;
  window.__AIVO_AD_FILM_ASSETS_V11__ = true;
  ...
  const styles = [
    ...
    "/css/ad-film.narration-player.css?v=1",
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.finalize-output.js?v=4",
