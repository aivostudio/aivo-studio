...
(() => {
  if (window.__AIVO_AD_FILM_ASSETS_V27__) return;
  window.__AIVO_AD_FILM_ASSETS_V27__ = true;
  ...
  const styles = [
    ...
    "/css/ad-film.production-status-center.css?v=3"
  ];
  ...
  const moduleScripts = [
    ...
    "/js/ad-film.role-upload-fix.js?v=4",
    ...
    "/js/ad-film.narration-engine.js?v=4",
    "/js/ad-film.narration-approval-sync.js?v=9",
    "/js/ad-film.narration-player-host-fix.js?v=1",
    "/js/ad-film.narration-player.js?v=2",
    "/js/ad-film.narration-master.js?v=5",
    ...
    "/js/ad-film.progress-lock.js?v=1",
    "/js/ad-film.progress-stability.js?v=3",
    ...
    "/js/ad-film.output-gallery.js?v=8",
