...
(function () {
  ...
  function atmoText(key, trText, enText) {
    try {
    ...
    return atmoLanguage() === "en" ? enText : trText;
  }

  function atmoToast(type, key, trText, enText) {
    const message = atmoText(key, trText, enText);
