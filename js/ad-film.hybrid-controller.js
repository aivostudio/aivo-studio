...
(function AIVO_AD_FILM_HYBRID_CONTROLLER(){
  ...
  document.addEventListener('click',function(event){
    ...
    (async function(){
      ...
      }catch(error){console.error('[ADFILM] hybrid controller',error);setBusy(button,false);notify(text('Hibrit reklam üretimi başlatılamadı: ','Hybrid production could not start: ')+clean(error&&error.message),'error')}
