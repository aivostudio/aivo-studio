  ...
  function api(){
    return{
      ...
      async uploadFile(projectId,file,kind){
        ...
        return{key:signed.key,url:signed.public_url,name:file.name,contentType:file.type,size:file.size,kind:kind,uploadedAt:new Date().toISOString(),_fingerprint:fingerprint(file)};
      }
    };
  }
