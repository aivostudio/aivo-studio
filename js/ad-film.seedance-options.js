...
(function AIVO_AD_FILM_SEEDANCE_OPTIONS(){
  "use strict";
  if(window.__AIVO_AD_FILM_SEEDANCE_OPTIONS_V6__) return;
  window.__AIVO_AD_FILM_SEEDANCE_OPTIONS_V6__=true;
  ...
  function normalizeQuality(value){value=String(value||"").toLowerCase();return QUALITIES.indexOf(value)>=0?value:"1080p"}
  ...
  function schedule(scope){[0,40,120,300,700].forEach(function(delay){setTimeout(function(){setup(scope||root())},delay)})}
