...
function inferAutomaticProfile(input) {
  ...
  if (keywordMatch(source, ["lastik", "otomobil", "araba", "motor", "otomotiv", "vehicle", "car ", "tire", "tyre"])) {
    return { style: "cinematic", energy: "strong", reason: "automotive" };
  }
  if (keywordMatch(source, ["spor", "fitness", "ayakkabı", "sneaker", "koşu", "antrenman", "sport", "workout"])) {
    return { style: "electronic", energy: "strong", reason: "sport" };
  }
  if (keywordMatch(source, ["çocuk", "oyuncak", "bebek", "kids", "child", "toy"])) {
    return { style: "pop", energy: "strong", reason: "children" };
  }
  if (keywordMatch(source, ["parfüm", "parfum", "perfume", "mücevher", "jewelry", "saat", "luxury", "lüks"])) {
    return { style: "cinematic", energy: "balanced", reason: "luxury" };
  }
  if (keywordMatch(source, ["kahve", "coffee", "kafe", "cafe", "çikolata", "chocolate", "tatlı", "dessert"])) {
    return { style: "rnb", energy: "calm", reason: "coffee_food" };
  }
  if (keywordMatch(source, ["restoran", "restaurant", "yemek", "food", "mutfak", "kitchen"])) {
    return { style: "latin", energy: "balanced", reason: "restaurant" };
  }
  if (keywordMatch(source, ["kozmetik", "cosmetic", "bakım", "beauty", "cilt", "skincare", "makyaj", "makeup"])) {
    return { style: "rnb", energy: "balanced", reason: "beauty" };
  }
  if (keywordMatch(source, ["teknoloji", "technology", "yapay zeka", "artificial intelligence", "uygulama", "software", "app ", "telefon", "phone", "kulaklık", "headphone"])) {
    return { style: "electronic", energy: "balanced", reason: "technology" };
  }
  if (keywordMatch(source, ["banka", "bank", "sigorta", "insurance", "hukuk", "law", "sağlık", "health"])) {
...
function buildAdFilmMusicPrompt(input = {}) {
  ...
  const visualStyle = VISUAL_STYLE_PROMPTS[visualStyleKey] || cleanText(input.visualStyle, 80);
  ...
  if (voiceStyle && voiceEnabled) contextParts.push(`The voice-over character is ${voiceStyle}.`);
  ...
  const negativePrompt = [
    "vocals", "singing", "spoken words", "lyrics", "voice", "choir",
    "copyrighted melody", "recognizable song", "long intro", "abrupt cutoff",
    "uncontrolled fade-out", "clipping", "distortion", "harsh noise",
    "audio watermark", "low quality",
  ].join(", ");
